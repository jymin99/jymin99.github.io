...
const AboutMe: React.FC = () => {
    return (
        <div className="w-screen h-screen bg-secondary flex justify between flex-col p-10">
            {/* 이름부분 */}
            <div className="flex flex-start flex-col text-end items-end justify-end text-primary text-[100px]">
                <div className=" font-mabeop">
                    <div>ABOUT</div>
                    <div>ME</div>
                </div>
                <div className="max-w-[350px] break-word font-pre text-[#F6F0CF] text-[20px] mb-10">
            ...
            <div className="flex flex-col text-start flex-end mt-auto">
                ...
                <div className="max-w-[1000px] break-word text-[#F6F0CF] text-[20px]">
